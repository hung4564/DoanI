              ...
              @foreach ($record->Lessons as $lesson)
                ...
                <tr>
                  ...
                  <td>
                    <div class="btn-group">
                      @can('view', $quiz)
                      <a href="{{route('dashboard::lessons.edit',$quiz->id)}}" class="btn btn-info btn-sm"><i class="fa fa-list"></i></a>
                      @endcan
                      @can('removeQuiz', $record)
                      <a href="{{route('dashboard::course.removelesson',[$record->id,$lesson->id])}}" class="btn btn-danger btn-sm"><i class="fa fa-minus"></i></a>
                      @endcan
                    </div>
                  </td>
                </tr>
...
<script>
  ...
  function addLesson(){
    var url= "{{route('dashboard::course.addlesson',[$record->id,"#link"])}}";
