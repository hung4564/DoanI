...
@section('breadcrumbs')
 {!! Breadcrumbs::render('dashboard::quizzes.detail',$record->id) !!}
@endsection
  ...
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <div class="col-md-8 col-sm-9">
        ...
        @else
          <button type="button" class="btn btn-default" onclick="location.href='{{route('dashboard::quizzes.enable',$record->id)}}'">Enable</button>
        @endif
        @if($record->IsPublic())
          <button type="button" class="btn btn-default" onclick="location.href='{{route('dashboard::quizzes.enable',$record->id)}}'">Unpublic</button>
        @else
          <button type="button" class="btn btn-default"onclick="location.href='{{route('dashboard::quizzes.public',$record->id)}}'">Public</button>
        @endif
